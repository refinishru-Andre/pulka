...
function calcGame(deal: Extract<Deal, { type: 'game' }>, seats: Seats, rules: Rules): DealDelta {
  ...
  //
  // За столом полвиста возможно ТОЛЬКО когда оба спасовали: заказ — пас — пас,
  // и тогда первый вистующий возвращает за полвиста. Розыгрыша не происходит,
  // игра идёт автоматом. Расклада «один вистует, другой за полвиста» не бывает:
  ...
  //
  // Работает она ТОЛЬКО когда один вистовал, а другой пасовал:
  //   джентльменский — висты пары делятся поровну между обоими защитниками,
  //                    пасовавший получает свою половину;
  //   жлобский       — всё забирает вистовавший, пасовавшему ноль.
  //
