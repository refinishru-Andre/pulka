...
//
// gentleman — висты защиты делятся ПОРОВНУ между обоими защитниками, включая
//             пасовавшего. Вистовал один, взятки взял он — половина всё равно
//             уходит напарнику.
// zhlob     — пишет только тот, кто вистовал. Пасовавший не получает ничего,
