...
function GameFormFields(props: {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Висты за прикуп — сдатчику за карты, которыми он помог играющему.
          В кодексе это «быстрые взятки», но за столом так никто не говорит. */}
      {rules.prikupBonus && (
        <div>
          <div className="text-xs text-slate-400 mb-1">
            Висты за прикуп
            <span className="ml-2 text-slate-500">
              за сколько взяток: Т или КД одной масти — 1, ТК одной масти — 2, два туза — 3
            </span>
          </div>
